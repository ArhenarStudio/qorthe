...
import { ProductComparisonPageClient } from "@/modules/product-comparison/components/ProductComparisonPageClient";
...
function mapShopifyToCatalog(
  node: ProductsResponse["products"]["nodes"][0]
): CatalogProduct {
  const price =
...
export default async function ComparePage() {
  ...
  return <ProductComparisonPageClient products={products} />;
}
