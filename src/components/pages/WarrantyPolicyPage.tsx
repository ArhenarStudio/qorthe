    ...
    >
      <div className="space-y-16">
        ...
        <section id="alcance" className="scroll-mt-32">
          ...
          <p>
            La presente Política de Garantía regula las condiciones aplicables a defectos de fabricación en los productos comercializados a través del sitio web operado por Qorthe´s Co. (en adelante, el “Titular”).
          </p>
          <p className="mt-4">
