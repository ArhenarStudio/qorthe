...
const headerTranslations = {
  es: { nav: { products: "Productos", about: "Nosotros", contact: "Contacto" } },
  en: { nav: { products: "Products", about: "About Us", contact: "Contact" } },
};
...
export function Header({
  ...
  const { isDarkMode, language, toggleDarkMode, toggleLanguage } = useAppState();
  const { cartCount } = useCart();
  const { isAuthenticated, user, signOut } = useAuth();
  const t = translationsProp ?? headerTranslations[language];
