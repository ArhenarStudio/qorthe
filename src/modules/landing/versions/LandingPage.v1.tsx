/**
 * Backup V1: Homepage antes de migrar al módulo landing.
 * Código original de app/page.tsx (2026-02-09).
 * No usar directamente; el componente activo es modules/landing/components/LandingPage.tsx
 */
"use client";
    ...
    <div className={isDarkMode ? "dark" : ""}>
      ...
      >
          ...
          <div className="mx-auto max-w-[1440px] px-4 md:px-8 lg:px-12">
            <div className="grid grid-cols-1 gap-8 md:gap-12 lg:grid-cols-2 lg:gap-16">
              ...
              <div className="flex flex-col justify-center space-y-6 md:space-y-8">
                ...
                <div className="space-y-4 md:space-y-6">
                  <p className={`text-sm md:text-base ${isDarkMode ? "text-[#b8a99a]" : "text-gray-600"}`}>
                ...
                <div className="grid grid-cols-3 gap-4 pt-4 md:gap-6 md:pt-6">
                  <div>
                    <div className={`mb-1 text-2xl md:mb-2 md:text-3xl lg:text-4xl ${isDarkMode ? "text-white" : "text-gray-900"}`}>28+</div>
                    <div className={`text-xs md:text-sm ${isDarkMode ? "text-[#b8a99a]" : "text-gray-600"}`}>{t.process.stats.years}</div>
                  </div>
                  <div>
                    <div className={`mb-1 text-2xl md:mb-2 md:text-3xl lg:text-4xl ${isDarkMode ? "text-white" : "text-gray-900"}`}>100%</div>
                    <div className={`text-xs md:text-sm ${isDarkMode ? "text-[#b8a99a]" : "text-gray-600"}`}>{t.process.stats.handmade}</div>
                  </div>
                  <div>
                    <div className={`mb-1 text-2xl md:mb-2 md:text-3xl lg:text-4xl ${isDarkMode ? "text-white" : "text-gray-900"}`}>5000+</div>
                    <div className={`text-xs md:text-sm ${isDarkMode ? "text-[#b8a99a]" : "text-gray-600"}`}>{t.process.stats.pieces}</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        >
          <div className="mx-auto max-w-[1440px] px-4 md:px-8 lg:px-12">
            <h2
              className={`mb-10 text-center text-2xl tracking-tight md:mb-12 md:text-3xl lg:mb-16 lg:text-4xl ${
                isDarkMode ? "text-white" : "text-gray-900"
              }`}
            >
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3 md:gap-8">
              {[t.testimonials.testimonial1, t.testimonials.testimonial2, t.testimonials.testimonial3].map((test, i) => (
                ...
                >
                  <p className={`mb-4 text-sm md:mb-6 md:text-base ${isDarkMode ? "text-[#b8a99a]" : "text-gray-600"}`}>
                    &quot;{test.text}&quot;
                  </p>
                  <div>
                    <p className={`font-medium ${isDarkMode ? "text-white" : "text-gray-900"}`}>{test.name}</p>
                    <p className={`text-xs md:text-sm ${isDarkMode ? "text-[#b8a99a]" : "text-gray-600"}`}>{test.location}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        >
          <div className="mx-auto max-w-[1440px] px-4 md:px-8 lg:px-12">
            <div className={`p-8 text-center md:p-12 lg:p-16 ${isDarkMode ? "bg-[#1a1512]" : "bg-gray-50"}`}>
              <h2
