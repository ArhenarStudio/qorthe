// ============================================================
// ADMIN MOCK DATA — RockStage Commerce / Qorthe
// ============================================================
...
export const orders: Order[] = [
  {
    ...
    customer: { name: 'David Pérez', email: 'arhenarstudio@gmail.com', phone: '662-361-0742', avatar: 'DP', tier: 'gold', points: 1450, totalOrders: 5, totalSpent: 12340, customerNotes: 'Prefiere empaque especial, siempre pide grabado' },
    items: [
      {
    ...
    communications: [
      { id: 'com1', type: 'email', subject: 'Confirmación de pedido', recipientEmail: 'arhenarstudio@gmail.com', date: '2026-02-28T10:31:00', status: 'delivered' },
      { id: 'com2', type: 'email', subject: 'Tu pedido está en producción', recipientEmail: 'arhenarstudio@gmail.com', date: '2026-02-28T11:00:00', status: 'delivered' },
    ],
...
export const financialData = {
  ...
  webServices: [
    ...
    { service: 'Dominio qorthe.com', cost: 148, plan: 'Anual /12', active: true },
  ...
  scheduledReports: [
    { name: 'Reporte semanal de ventas', freq: 'Cada lunes', email: 'admin@qorthe.com', active: true },
...
export const mockEmailCampaigns: EmailCampaign[] = [
  ...
  { id: 'ec4', name: 'Te extrañamos', segment: 'Inactivos >90d', sentCount: null, openRate: null, clickRate: null, revenue: null, status: 'scheduled', scheduledDate: '2026-03-05', subject: '{nombre}, te extrañamos en Qorthe 🌳' },
