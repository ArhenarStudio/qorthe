    ...
    >
      ...
      <div className="mb-4">
        <div
          ...
          style={{ background: 'linear-gradient(135deg, var(--accent), #8B5CF6)', boxShadow: '0 4px 12px rgba(99,102,241,0.3)' }}
        >
          ...
          return (
            <div key={item.id} className="relative">
              <button
                ...
                style={{
                  backgroundColor: isActive ? 'var(--sidebar-active)' : isHovered ? 'rgba(255,255,255,0.05)' : 'transparent',
      ...
      <div className="flex flex-col items-center gap-2 mt-2">
        ...
        <div className="w-8 h-8 rounded-full flex items-center justify-center text-[10px] font-bold"
          style={{ background: 'linear-gradient(135deg, var(--accent), #8B5CF6)', color: '#FFFFFF' }}>
          {initials}
        </div>
      </div>
    </nav>
