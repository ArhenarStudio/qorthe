  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundColor: searchFocused ? 'var(--surface)' : 'var(--surface2)',
      ...
      >
        ...
        <kbd className="text-[9px] px-1.5 py-0.5 rounded"
          style={{ backgroundColor: 'var(--border)', color: 'var(--text-muted)', fontFamily: 'var(--font-mono)' }}>
          ⌘K
        </kbd>
      </div>
            ...
            {PERIODS.map(p => (
              <button key={p.value} onClick={() => { onPeriodChange(p.value); setPeriodOpen(false); }}
                ...
                style={{
                  ...
                  backgroundColor: period === p.value ? 'var(--sidebar-active)' : 'transparent',
                  fontFamily: 'var(--font-body)',
