# RockSage Commerce — Admin Panel Architecture

> **Última actualización:** 2026-03-10
> **Aplica a:** DavidSon's Design (Tenant 0) y cualquier tenant futuro de RockSage Commerce
...
## 9. DSD como Tenant 0 de RockSage Commerce

`DavidSon's Design` es el Tenant 0 — corre sobre la misma infraestructura
que cualquier tenant futuro de RockSage Commerce.
...
- Los módulos admin son productos de **RockSage Commerce**, no de DSD
