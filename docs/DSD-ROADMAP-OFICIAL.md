...
4.2  [ ] Test checkout e2e con MercadoPago
         ...
         — ✅ Idempotency keys (10-min bucket payments, deterministic refunds)
         — ✅ X-Idempotency-Key mandatory on all MP API calls
         — ✅ MercadoPagoBrick calls preflight before submitting
         — ✅ ROOT CAUSE FIXED: Products had NULL shipping_profile_id (SQL INSERT)
